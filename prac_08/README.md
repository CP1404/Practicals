...
-   **Objects** store data in instance variables and provide access to
    the **methods** (functions) defined in the class

Inheritance: "is a" relationship

Inheritance is appropriate where you are building a more specialised
version of a class.
...
-   We can *override* (customise) derived classes by modifying existing
    ...
    a fare, and in UnreliableCar it may or may not drive... but in all
    cases, the method takes in a distance value and returns the distance
    driven.
...
will work the same whether the object is a Taxi or SilverServiceTaxi,
but the results (including the price) do depend on the class. This is
***polymorphism***.
...
Create two more kinds of cars that make sense to you and test them, e.g.
select from:
