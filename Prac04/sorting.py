...
# This tells the sort method to use the second (index 1, age) value in the element
names_with_ages.sort(key=itemgetter(1))
print(names_with_ages)

data = [['Derek', 7], ['Carrie', 7], ['Bob', 6], ['Aaron', 6]]
# This tells the sort method to use the second (index 1) value then the first (index 0) in the element
